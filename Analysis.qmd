...
resultsToSave$correlation$corrs
```
...
```{r, eval = chunkEval}
pdf('figures/Fig.2-predictabilityWithin.pdf', height = 9, width = 14)
...
```{r, eval = chunkEval}
pdf('figures/Fig.3-predictabilityBetween.pdf', height = 9, width = 14)
