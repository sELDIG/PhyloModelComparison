...
metricsForManyTrees(list.files("trees/uniform_sampling_experiment"),
                    ...
                    treefileOut = "derived_tree_data/USE_treeStats.txt", append = F)
...
# write.csv(paramKey, 'derived_tree_data/simulation_parameters_key.csv', row.names = F)

paramKey = read.csv('derived_tree_data/simulation_parameters_key.csv')
...
simuData <- read.csv("derived_tree_data/process_parameter_values_and_tree_metrics_sign_corrected.csv", stringsAsFactors = T)
simuDataKey <- read.csv("derived_tree_data/simulation_parameters_key.csv")
