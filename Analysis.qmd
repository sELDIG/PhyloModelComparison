...
resultsToSave$correlation$R2MatFull = R2MatFull
resultsToSave$correlation$pMatFull = pMatFull
```
...
```{r, eval = chunkEval}
pdf('figures/variableImportance.pdf', height = 15, width = 13)
par(mfrow = c(1,1), mar = c(4,15,3,3), oma = c(3, 0, 2, 0))
...
## Figure predictability between models
