...
bp1 = boxplot(log10(simuData$number_of_lineages) ~ simuData$model3, main = 'log # of lineages', col = rainbow(8), xaxt = 'n', tck = -0.01, xlab = '')
axis(1, at = 1:8, labels = bp1$names, las = 2, cex.axis = 1.4, tck = -0.01)

for (i in statisticsIndices2) { 
  bp = boxplot(simuData[,i] ~ simuData$model3, main = names(simuData)[i], col = rainbow(8), xaxt = 'n', tck = -0.01, xlab = '')
