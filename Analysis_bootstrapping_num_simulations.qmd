...
If tree metrics have already been calculated on all simulated trees, you may skip this code chunk and begin with the **Read and Process Data** section.
...
# Bootstrap iteration (value of 1:5)
boot = 2
set.seed(boot)
...
pdf(paste0('figures/Figure1_metric_correlations_bootstrap', boot, '.pdf'), height = 15, width = 13)
...
pdf(paste0('figures/Figure2_withinmodel_bootstrap', boot, '.pdf'), 
    height = 8, width = 10)
...
pdf(paste0('figures/Figure3_crossmodel_bootstrap', boot, '.pdf'), 
    height = 7, width = 14)
